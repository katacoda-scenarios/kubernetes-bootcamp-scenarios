Mari kita periksa apakah aplikasi yang kita _deploy_ di skenario sebelumnya sedang berjalan. Kita akan menggunakan `kubectl get` command dan melihat Pod yang ada:
